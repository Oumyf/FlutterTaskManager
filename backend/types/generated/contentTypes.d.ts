...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "T\u00E2ches de l'application Flutter";
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    ...
    attachmentsJson: Schema.Attribute.Text;
    audioPath: Schema.Attribute.String;
    checklistJson: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
